...
//               .findFragmentById(R.id.map);map
//
////        mLocationMarkerText = (TextView) findViewById(R.id.locationMarkertext);
////        mLocationAddress = (EditText) findViewById(R.id.start);
////        mLocationText = (TextView) findViewById(R.id.destination);
